...
export default function HomeV2() {
  ...
  // ダミーデータ
  const taskData = [
    { priority: "高", taskName: "顧客へ見積送付", assignee: "山田太郎", deadline: "2024/07/10", daysLeft: "3日", status: "進行中", project: "A社案件", auto: "AI自動" },
    { priority: "中", taskName: "商談Bの準備", assignee: "鈴木一郎", deadline: "2024/07/12", daysLeft: "1日", status: "未着手", project: "B社案件", auto: "手動" },
    { priority: "高", taskName: "C社 提案書ドラフト作成", assignee: "佐藤花子", deadline: "2024/07/15", daysLeft: "2日", status: "進行中", project: "C社新規案件", auto: "AI自動" },
    { priority: "中", taskName: "D社 定例会議準備", assignee: "田中次郎", deadline: "2024/07/13", daysLeft: "0日", status: "進行中", project: "D社サポート案件", auto: "手動" },
    { priority: "高", taskName: "E社 契約書レビュー", assignee: "山田太郎", deadline: "2024/07/09", daysLeft: "1日", status: "完了", project: "E社更新案件", auto: "AI自動" },
    { priority: "低", taskName: "F社 サポート対応", assignee: "鈴木一郎", deadline: "2024/07/20", daysLeft: "0日", status: "未着手", project: "F社サポート案件", auto: "手動" },
    { priority: "高", taskName: "G社 進捗報告作成", assignee: "佐藤花子", deadline: "2024/07/11", daysLeft: "0日", status: "進行中", project: "G社大型案件", auto: "AI自動" },
    { priority: "中", taskName: "H社 顧客ヒアリング", assignee: "田中次郎", deadline: "2024/07/18", daysLeft: "0日", status: "進行中", project: "H社新規案件", auto: "手動" },
    { priority: "低", taskName: "I社 サービス説明資料作成", assignee: "山田太郎", deadline: "2024/07/22", daysLeft: "0日", status: "未着手", project: "I社新規案件", auto: "AI自動" },
    { priority: "高", taskName: "J社 受注処理", assignee: "鈴木一郎", deadline: "2024/07/14", daysLeft: "0日", status: "進行中", project: "J社大型案件", auto: "手動" }
  ]
  ...
  const riskData = [
    ...
    { priority: "高", project: "海外展開サポート", assignee: "佐藤花子", deadline: "2024/07/15", daysLeft: "2日", status: "進行中", risk: "顧客要望未対応" },
    { priority: "中", project: "契約更新交渉", assignee: "田中次郎", deadline: "2024/07/18", daysLeft: "0日", status: "進行中", risk: "承認遅延" },
    { priority: "高", project: "新規サービス提案", assignee: "山田太郎", deadline: "2024/07/20", daysLeft: "0日", status: "未着手", risk: "顧客連絡途絶" },
    { priority: "中", project: "データ移行プロジェクト", assignee: "鈴木一郎", deadline: "2024/07/25", daysLeft: "5日", status: "進行中", risk: "技術的課題" },
    { priority: "高", project: "セキュリティ強化案件", assignee: "佐藤花子", deadline: "2024/07/16", daysLeft: "3日", status: "進行中", risk: "リソース不足" },
    { priority: "中", project: "クラウド移行案件", assignee: "田中次郎", deadline: "2024/07/19", daysLeft: "4日", status: "未着手", risk: "スケジュール遅延" },
    { priority: "高", project: "AI導入支援案件", assignee: "山田太郎", deadline: "2024/07/21", daysLeft: "6日", status: "進行中", risk: "予算超過" },
    { priority: "中", project: "業務効率化案件", assignee: "鈴木一郎", deadline: "2024/07/17", daysLeft: "2日", status: "進行中", risk: "要件変更" }
  ]
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white border border-gray-100 rounded-xl shadow p-4">
                <Tabs defaultValue="tasks" className="w-full" value={currentTab} onValueChange={setCurrentTab}>
                  ...
                  <Button variant="ghost" size="icon" className="h-9 w-9 shrink-0 pl-4 pr-6">
