...
function Header({ onClear }: { onClear: () => void }) {
  return (
    <header className="h-14 min-h-14 w-full flex items-center justify-between px-8 bg-white/80 border-b shadow-sm">
              <span className="text-base font-bold tracking-tight">デモ環境</span>
...
const todayActionData = [
  {
    ...
    why: "顧客の期待に応える機会 - 前回の商談から1週間経過し、顧客の関心を維持する重要なタイミング",
    when: "今日 17:00まで",
    who: "山田 太郎",
    priority: "緊急",
    relatedCase: "A社向けシステム開発案件",
  ...
  },
  {
    id: "action-002", 
    what: "B社向け提案書の最終確認",
    why: "決裁者を動かす機会 - 来週の最終プレゼンに向けて、経営判断に必要な情報を整理",
    when: "明日 10:00まで",
    who: "佐藤 花子",
    priority: "重要",
  ...
  },
  {
    id: "action-003",
    what: "C社向け競合対応戦略の策定",
    why: "競合優位性確保の機会 - 競合他社の動向を把握し、差別化ポイントを明確化",
    when: "今日 15:00まで",
    who: "鈴木 一郎",
    priority: "緊急",
  ...
  },
  {
    id: "action-004",
    what: "D社向け価格交渉の準備",
    why: "企業価値向上の機会 - 顧客の予算制約を理解し、価値提案で説得",
    when: "明日 14:00まで",
    who: "田中 次郎",
    priority: "重要",
  ...
  },
  {
    id: "action-005",
    what: "E社向け技術検証の結果報告",
    why: "顧客の心を動かす機会 - 技術的課題の解決により、顧客の信頼を獲得",
    when: "今日 18:00まで",
    who: "高橋 美咲",
    priority: "緊急",
