...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 align-middle text-sm font-normal text-gray-700 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-4 text-xs font-normal text-gray-700", className)}
    {...props}
  />
))
