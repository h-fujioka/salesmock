...
const DropdownMenuSubTrigger = React.forwardRef<
  ...
  Omit<React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubTrigger>, "inset"> & { inset?: boolean }
...
const DropdownMenuItem = React.forwardRef<
  ...
  Omit<React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Item>, "inset"> & { inset?: boolean }
>(({ className, inset, ...props }, ref) => (
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 pl-8 text-sm outline-none focus:bg-accent data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    checked={checked}
    {...props}
